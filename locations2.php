                ...
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color:yellow">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">ROOF TOP GARDEN</h4>
                                    </div>
                                    <div class="row">
                                        <div class="modal-body">
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE PRIVATE DINING EXPERIENCE</h5>
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">RJ Private Dining Room</h1>
                            <p class="location" style="color:green">
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-8">
                            ...
                            <p class="location" style="color:green">The Rocks 18 Argyle Street</p>
                            <p class="definition">
                ...
                <section>
                    <div class="container">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="modal-body">
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE BAVARIA AT MELBOURNE’S SOUTH WHARF</h5>
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            ...
                            <p class="location" style="color:green">45 South Wharf Promenade</p>
